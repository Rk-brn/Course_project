...
#include <Windows.h>
#include "Category.h"
#include "CategoryForm.h"  // ¬ключаем заголовочный файл CategoryForm
namespace Courseproject {
	...
	/// <summary>
	/// —водка дл€ Table_Category_TransactionForm
	/// </summary>
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(189, 267);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->Size = System::Drawing::Size(517, 210);
			this->dataGridView1->TabIndex = 0;
			this->dataGridView1->AllowUserToAddRows = false;
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(231, 538);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(435, 538);
			...
			this->ClientSize = System::Drawing::Size(1272, 696);
