...
namespace Courseproject {
    ...
    {
        InitializeComponent();
        dataGridViewConversions->Columns->Add("Balance", "Баланс");
        dataGridViewConversions->Columns->Add("ConvertedBalance", "Конвертированный баланс");
        dataGridViewConversions->Columns->Add("Rate", "Курс");
    ...
    System::Void CurrencyConverterForm::вернутьсяКСчетамToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
    {
        this->Close();
        return System::Void();
    }
    ...
    System::Void CurrencyConverterForm::редактироватьВалютуToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e)
    {
