...
Courseproject::TransactionForm::TransactionForm(Courseproject::CategoryForm^ categoryForm)
{
	throw gcnew System::NotImplementedException();
}

System::Void Courseproject::TransactionForm::button_TransactionCreat_Click(System::Object^ sender, System::EventArgs^ e)
{
	return System::Void();
}
